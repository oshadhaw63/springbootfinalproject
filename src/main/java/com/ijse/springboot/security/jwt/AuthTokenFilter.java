package com.ijse.springboot.security.jwt;
...
import com.ijse.springboot.security.UserDetailsServiceImpl;
...
public class AuthTokenFilter<UserDetails, JwtUtils> extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws IOException, ServletException {
        ...
        try {
            ...
            if(jwt != null && ((Object) jwtUtils).validateToken(jwt)) {
